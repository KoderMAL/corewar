...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/06 14:37:58 by stoupin           #+#    #+#             */
/*   Updated: 2018/03/06 14:38:32 by stoupin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_rectangle(t_gui *gui, t_coord top_left, t_coord dim, t_pix color)
{
	...
	draw_horizontal_line(gui, (t_coord){top_left.x, top_left.y + dim.y},
							dim.x, color);
	draw_vertical_line(gui, top_left, dim.y, color);
	draw_vertical_line(gui, (t_coord){top_left.x + dim.x, top_left.y},
							dim.y, color);
}
